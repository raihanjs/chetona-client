...
export default function BookCard({ book, margin }) {
  const { name, img, price } = book;
  return (
    <div
      className={`${margin} w-[150px] sm:w-[180px] px-4 py-2 rounded-md border-2 hover:border-[#40A4DC] transition-all hover:shadow-2xl relative`}
    >
      {/* Book Img */}
      <Link t0="">
        <img
